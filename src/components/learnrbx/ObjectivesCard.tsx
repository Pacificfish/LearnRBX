...
export default function ObjectivesCard({ items, title = 'Learning Objectives' }: ObjectivesCardProps) {
  return (
    <div className="card bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-100 dark:from-blue-900/20 dark:to-indigo-900/20 dark:border-blue-800 p-3">
